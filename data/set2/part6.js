...
window.TOEIC_DATA_2.part6 = [
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "answer": 1,
        "explanation": "文挿入問題。直前の『録画を後日提供する』を受けて、その利点を説明する『ご自身のペースで復習できる』が自然。(A)は開催の趣旨と矛盾、(B)は会場のないオンライン開催と矛盾、(D)は録画の話とつながらない。"
      },
      {
        "num": 4,
        "choices": [
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "answer": 2,
        "explanation": "文挿入問題。『働き、つながる場を提供したい』というチョイ氏の発言に続くので、『会員同士の協働を促す設計』がテーマに合う。(B)は開業予定と矛盾、(C)は契約済みという事実と矛盾、(D)は文脈に無関係。"
      },
      {
        "num": 4,
        "choices": [
