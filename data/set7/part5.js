...
window.TOEIC_DATA_7.part5 = [
  ...
  {
    "id": "s7p5-21",
    "q": "Department managers are asked to submit their revised headcount figures by Friday, ______ the budget review scheduled for the following week.",
    "choices": [
      "in charge of",
      "in return for",
      "in advance of",
    ...
    "answer": 2,
    "translation": "各部門長は、翌週に予定されている予算検討会に先立ち、金曜日までに修正後の人員数を提出するよう求められている。",
    "explanation": "提出期限が金曜、検討会は『翌週』なので、提出は検討会より前。よって (C) in advance of 〜(〜に先立って)が正解。(A) in charge of は『〜を担当して』、(B) in return for は『〜の見返りに』、(D) in excess of は『〜を超えて』。4つとも in+名詞+of の形で、形では絞れない。『by Friday』と『the following week』という2つの時点の前後関係を読み取って初めて決まる、文脈依存タイプの問題。"
  },
  {
    "id": "s7p5-22",
