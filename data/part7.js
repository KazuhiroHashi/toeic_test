...
window.TOEIC_DATA.part7 = [
  {
    ...
    "passages": [
      {
        "docType": "Notice",
        "text": "RIVERSIDE FITNESS CENTER — MEMBER NOTICE\n\nOur indoor pool will be out of use from Monday, August 4, through Sunday, August 10, while the tiles are repaired and the basin is cleaned. Everything else — the weight room, the studios, and the sauna — will run on the usual schedule.\n\nAqua-fitness sessions are not being dropped. For that week only they move to Westbrook Aquatic Center on Pine Street, and each session starts at the same hour as it does here. Show the card you use at our front desk and you will be let in at no additional cost.\n\nThe pool returns to service at 6:00 A.M. on Monday, August 11. We are sorry for the disruption and thank you for your patience."
      }
    ],
    "translation": "リバーサイド・フィットネスセンター——会員の皆様へ\n\n屋内プールは、タイル補修と水槽清掃のため、8月4日(月)から8月10日(日)まで使用できません。ウエイトルーム、スタジオ、サウナなど他の施設は通常通り営業します。\n\nアクアフィットネスの各回は中止しません。その週に限りパイン通りのウェストブルック・アクアティックセンターで開催し、開始時刻は当センターと同じです。当センターの受付で使っているカードを提示すれば、追加料金なしで入館できます。\n\nプールは8月11日(月)午前6時に再開します。ご不便をおかけしますが、ご理解のほどよろしくお願いいたします。",
    "questions": [
      {
      ...
      },
      {
        ...
        "choices": [
          ...
          "They will not be held that week.",
    ...
    "questions": [
      ...
      },
      {
        ...
        "choices": [
          ...
          "He is relieved by what Ms. Klein has just told him."
        ],
        "answer": 3,
        "explanation": "意図問題。直前でクラインさんが『あったわ』と伝えたことへの返答なので、『心配事が1つ片づいた=知らせを聞いて安心した』という意味の(D)が正解。list という語につられた(B)、crisis を仕事上の問題ととった(C)は誤り。"
      }
    ]
  },
  {
    ...
    "questions": [
      {
        ...
        "choices": [
          ...
          "Post a sheet on the notice board",
          "Report their sales for the fourth quarter"
        ],
        "answer": 1,
        "explanation": "put your name against one of them no later than November 10(11月10日までに空き時間に名前を書く)が根拠で、面談の時間を選ぶこと。(A)は本文の training をそのまま含むひっかけ。掲示板のシートはすでに掲示済みなので(C)も誤り。"
      },
      {
        ...
        "answer": 1,
        "explanation": "what you write there is what I will use when I argue for the department's training budget(研修予算を求める材料にする)が根拠で、予算=お金の配分に影響する(B)が正解。(C)は本文の November 10 をそのまま含むが、その日付は面談枠を選ぶ期限。"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "questions": [
      ...
      {
        "q": "What is Ms. Kowalski told to do with the bowl she received?",
        "choices": [
  ...
  },
  {
    ...
    "passages": [
      {
        "docType": "Online chat",
        "text": "Mika Anders (2:04 P.M.)\nLeo, the projector in Room 5 won't pick up my laptop. The sales demo starts at 2:30.\n\nLeo Grant (2:05 P.M.)\nDid you swap in the gray cable from the drawer?\n\nMika Anders (2:06 P.M.)\nTwice. I also tried it with Ravi's machine — same blank screen.\n\nLeo Grant (2:07 P.M.)\nThen the fault isn't in your computer. I'm two floors up; give me five minutes.\n\nMika Anders (2:08 P.M.)\nThanks. If it comes to it, I'll keep the client in the lobby for a while.\n\nRavi (2:09 P.M.)\nI just walked past Room 8 — it's free until four. The projector in there was working this morning.\n\nMika Anders (2:10 P.M.)\nGood to know. Moving eleven people at 2:25 would be messy, but it beats standing in the lobby.\n\nLeo Grant (2:12 P.M.)\nI'm in Room 5 now. The wall plate is loose, so the cable isn't pushed in all the way. I can fix that, but I need a screwdriver from my desk.\n\nMika Anders (2:13 P.M.)\nHow long?\n\nLeo Grant (2:14 P.M.)\nTen minutes, no more. If it isn't up by 2:25, take Room 8.\n\nRavi (2:15 P.M.)\nI'll put a sign on the door of Room 8 so nobody takes it in the meantime. Mika, send me the client list and I'll meet them at reception.\n\nMika Anders (2:16 P.M.)\nSending it now. Thanks, both of you."
      }
    ],
    "translation": "ミカ・アンダース(午後2:04):レオ、5号室のプロジェクターが私のノートパソコンを認識しないの。営業デモは2時半開始よ。\nレオ・グラント(午後2:05):引き出しのグレーのケーブルに替えてみた?\nミカ・アンダース(午後2:06):2回ね。ラヴィのパソコンでも試したけど、同じで画面は真っ黒。\nレオ・グラント(午後2:07):じゃあ原因は君のパソコンじゃないね。2階上にいるから、5分ちょうだい。\nミカ・アンダース(午後2:08):ありがとう。いざとなったら、ロビーでお客様をしばらく引き止めておくわ。\nラヴィ(午後2:09):いま8号室の前を通ったけど、4時まで空いているよ。あそこのプロジェクターは今朝は動いていた。\nミカ・アンダース(午後2:10):助かる。2時25分に11人を移動させるのは大変だけど、ロビーで待たせるよりはまし。\nレオ・グラント(午後2:12):いま5号室にいる。壁の端子板が緩んでいて、ケーブルが奥まで刺さっていない。直せるけど、自分の席からドライバーを取ってくる必要がある。\nミカ・アンダース(午後2:13):どのくらいかかる?\nレオ・グラント(午後2:14):10分、それ以上はかからない。2時25分までに映らなければ8号室を使って。\nラヴィ(午後2:15):8号室のドアに札を貼って、その間に誰にも取られないようにしておく。ミカ、お客様のリストを送ってくれれば、受付で出迎えるよ。\nミカ・アンダース(午後2:16):いま送るわ。二人ともありがとう。",
    "questions": [
      {
        "q": "What has Ms. Anders already done?",
        "choices": [
          "She has ordered a replacement projector.",
          "She has moved the sales demo to another room.",
          "She has tested the projector with a colleague's computer.",
          "She has taken the client to the lobby."
        ],
        "answer": 2,
        "explanation": "I also tried it with Ravi's machine(同僚のパソコンでも試した)が根拠。(B)の sales demo と(D)の lobby はいずれも本文の語をそのまま含むひっかけで、部屋の移動も客の案内も、この時点では行われていない。"
      },
      {
      ...
      {
        "q": "What does Mr. Grant say is causing the trouble?",
        "choices": [
          "A cable that is not fully connected",
          "A fault in Ms. Anders's laptop",
          "A projector that has lost power",
          "A room that was booked twice"
        ],
        "answer": 0,
        "explanation": "午後2時12分の『壁の端子板が緩んでいて、ケーブルが奥まで刺さっていない』が根拠で(A)が正解。(B)は本文の laptop を含むひっかけで、午後2時07分に『原因は君のパソコンではない』と否定されている。"
      },
      {
        "q": "What does Ravi say he will do?",
        "choices": [
          "Bring a screwdriver from Mr. Grant's desk",
          "Book Room 8 for the following week",
          "Send Ms. Anders the client list",
          "Make sure Room 8 stays free"
        ],
        "answer": 3,
        "explanation": "午後2時15分の『8号室のドアに札を貼って、その間に誰にも取られないようにする』が根拠で(D)が正解。(A)のドライバーはグラントさんが自分の席から取ってくるもの、(C)のお客様のリストはアンダースさんがラヴィに送るもので、どちらも本文の語を入れ替えたひっかけ。"
      }
    ]
  },
  {
    ...
    "questions": [
      ...
      {
        "q": "What is indicated about Dr. Osei's session?",
        "choices": [
          "It will be held in a smaller room this year.",
          "It will be limited to 15 minutes.",
          "It will be recorded for later viewing.",
          "It will be open only to guests of the Lakeside Hotel."
        ],
        "answer": 2,
        "explanation": "your session will be recorded と、オンラインプログラムに申し込んだ人が1か月間視聴できるという記述から(C)が正解。(B)は本文の 15 minutes を流用したひっかけで、15分は講演後の質疑の時間。(D)も本文の Lakeside Hotel を使っただけで、視聴条件はホテルの宿泊とは無関係。"
      }
    ]
  },
  {
