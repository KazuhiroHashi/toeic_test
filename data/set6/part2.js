...
window.TOEIC_DATA_6.part2 = [
  {
    ...
    "question": {
      "speaker": "W",
      "text": "Where's the nearest post office to mail this package?"
    },
    "choices": [
  ...
  },
  {
    ...
    "question": {
      "speaker": "M",
      "text": "When will the software license expire?"
    },
    "choices": [
    ...
    "explanation": "When(いつ)に対して時期を答えている(C)が正解。(A)はlicense/licensingの派生語+場所のひっかけ、他の選択肢は料金を答える連想のひっかけ。"
  },
  {
    "id": "s6p2-03",
    "question": {
      "speaker": "W",
      "text": "Who's organizing the retirement party for Mr. Reyes?"
    },
    "choices": [
    ...
    "explanation": "Who(誰)に対して人を答えている(B)が正解。(A)は場所、(B)は時で、どちらも問いに合わない。"
  },
  {
    "id": "s6p2-04",
    "question": {
      "speaker": "M",
      "text": "Have you updated the emergency contact list?"
    },
    "choices": [
  ...
  },
  {
    ...
    "question": {
      "speaker": "W",
      "text": "Do you want the handouts in color or in black and white?"
    },
    "choices": [
    ...
    "explanation": "A or B の選択疑問文にはYes/Noで答えられない。カラーを選んだ(C)が正解。(A)は選択疑問文にYesで不可、他の選択肢は部数の連想ひっかけ。"
  },
  {
    "id": "s6p2-06",
    "question": {
      "speaker": "M",
      "text": "Why was the product recall announced?"
    },
    "choices": [
    ...
    "answer": 2,
    "translation": "なぜ製品のリコールが発表されたのですか?\n(A) すぐに仕入先に折り返し電話します。\n(B) 今朝の記者会見でです。\n(C) 一部の製品に欠陥のあるセンサーが見つかったからです。",
    "explanation": "Why(なぜ)に対して理由を答えている(C)が正解。(B)はWhen/Whereの応答で理由になっていない、他の選択肢はrecall/callの音のひっかけ。"
  },
  {
    "id": "s6p2-07",
    "question": {
      "speaker": "W",
      "text": "How do new employees clock in with the updated system?"
    },
    "choices": [
    ...
    "explanation": "How(方法)に対して手段を答えた(A)が正解。他の選択肢はclock in/clockの繰り返しひっかけ、(B)はWhen(いつ)の応答で方法になっていない。"
  },
  {
    "id": "s6p2-08",
    "question": {
      "speaker": "M",
      "text": "The vending machine keeps rejecting my coins."
    },
    "choices": [
    ...
    "answer": 0,
    "translation": "自動販売機が硬貨を受け付けてくれないんです。\n(A) 代わりに休憩室のものを使ってみてください。\n(B) では水を1本もらいます。\n(C) はい、先月設置されたばかりです。",
    "explanation": "疑問文ではなく『不具合の報告』。それに対して代替策を提案した(B)が自然。他の選択肢は連想のひっかけ、(C)はvending machine(自販機)から飲み物を連想させるひっかけ。"
  },
  {
    "id": "s6p2-09",
    "question": {
      "speaker": "W",
      "text": "Could you water the plants while I'm away next week?"
    },
    "choices": [
    ...
    "explanation": "依頼(Could you 〜?)に対して快諾した(B)が正解。(A)はwaterの繰り返しひっかけ、他の選択肢はplant(植物/植える)の派生語ひっかけ。"
  },
  {
    "id": "s6p2-10",
    "question": {
      "speaker": "M",
      "text": "The photocopier lease ends next month, doesn't it?"
    },
    "choices": [
  ...
  },
  {
    ...
    "question": {
      "speaker": "W",
      "text": "Which delivery company handled our last shipment?"
    },
    "choices": [
    ...
    "explanation": "Which(どの)に対して The one 〜 で特定した(A)が正解。他の選択肢はWH疑問文にYesで答えており不可、(B)はWhere(どこへ)の応答。"
  },
  {
    "id": "s6p2-12",
    "question": {
      "speaker": "M",
      "text": "Do you know where the first-aid kit is kept?"
    },
    "choices": [
  ...
  },
  {
    ...
    "question": {
      "speaker": "W",
      "text": "Why don't we reschedule the site visit for Friday?"
    },
    "choices": [
    ...
    "answer": 2,
    "translation": "現地視察を金曜日に組み直しませんか?\n(A) ウェブサイトは今、作り直しているところです。\n(B) その現場からの眺めは素晴らしいですよ。\n(C) いい考えですね、その日はみんな空いています。",
    "explanation": "Why don't we 〜? は理由を聞いているのではなく『提案』。同意した(C)が正解。(B)はsite/websiteの音のひっかけ、他の選択肢はsiteの繰り返しひっかけ。"
  },
  {
    "id": "s6p2-14",
    "question": {
      "speaker": "M",
      "text": "How much does a booth at the job fair cost?"
    },
    "choices": [
    ...
    "explanation": "How much(いくら)に対して金額を答えた(A)が正解。(A)はWhere(どこ)の応答、(C)はfair(フェア/晴れの)の多義語による音のひっかけ。"
  },
  {
    "id": "s6p2-15",
    "question": {
      "speaker": "W",
      "text": "Who set the agenda for tomorrow's board meeting?"
    },
    "choices": [
    ...
    "answer": 2,
    "translation": "明日の役員会議の議題は誰が決めたのですか?\n(A) 役員会議室でです。\n(B) 12項目くらいの長さです。\n(C) 実は、私はまだ議題を見ていないんです。",
    "explanation": "Whoに人名で答えず『まだ見ていない(=分からない)』と間接的に返す応答。この『わからない系』はPart 2の頻出正解パターン。(B)はboardの繰り返しひっかけ、他の選択肢は項目数の連想ひっかけ。"
  },
  {
    "id": "s6p2-16",
    "question": {
      "speaker": "M",
      "text": "Where should we display the new product samples?"
    },
    "choices": [
    ...
    "answer": 0,
    "translation": "新製品のサンプルはどこに陳列しましょうか?\n(A) 正面のウィンドウは季節商品用に取ってありませんでしたっけ?\n(B) はい、私も無料サンプルをもらいました。\n(C) 月のちょうど末にです。",
  ...
  },
  {
    ...
    "question": {
      "speaker": "W",
      "text": "When does this year's internship program begin?"
    },
    "choices": [
    ...
    "answer": 1,
    "translation": "今年のインターンシップ制度はいつ始まりますか?\n(A) はい、研修室でです。\n(B) 人事の担当者が日程をオンラインに載せていますよ。\n(C) その制度は去年とても好評でした。",
    "explanation": "変化球:日付を答えず『情報のありか(人事が掲載済み)』を教えるパターン。『そこを見れば分かる』型の間接応答。(A)はprogramの繰り返しひっかけ、他の選択肢はWH疑問文にYesで不可。"
  },
  {
    "id": "s6p2-18",
    "question": {
      "speaker": "M",
      "text": "Has payroll processed this month's bonuses yet?"
    },
    "choices": [
    ...
    "answer": 2,
    "translation": "給与部門は今月のボーナスをもう処理しましたか?\n(A) 私は去年、少額のボーナスをもらいました。\n(B) はい、支払い処理は簡単でした。\n(C) 経理部はまだ監査で閉まっているんです。",
    "explanation": "変化球:Yes/Noを言わず『経理がまだ閉まっている』と述べて『まだ処理されていない』を含意するパターン。推論が必要。(B)はbonusの繰り返しひっかけ、他の選択肢はprocessの派生語ひっかけ。"
  },
  {
    "id": "s6p2-19",
    "question": {
      "speaker": "W",
      "text": "Why is the west staircase blocked off today?"
    },
    "choices": [
  ...
  },
  {
    ...
    "question": {
      "speaker": "M",
      "text": "Should we hire a temp or ask the team to work overtime?"
    },
    "choices": [
    ...
    "answer": 0,
    "translation": "臨時スタッフを雇うべきですか、それともチームに残業を頼むべきですか?\n(A) チームのほとんどは来週すでに予定が埋まっています。\n(B) はい、それでいいと思います。\n(C) 昨夜は気温が急に下がりました。",
    "explanation": "変化球:どちらとは言わず『チームは手一杯』という事実を伝えて『臨時スタッフにしよう』を含意するパターン。他の選択肢は選択疑問文にYesで不可、(B)はtemp/temperatureの音のひっかけ。"
  },
  {
    "id": "s6p2-21",
    "question": {
      "speaker": "W",
      "text": "Who's covering the reception desk during the conference?"
    },
    "choices": [
  ...
  },
  {
    ...
    "question": {
      "speaker": "M",
      "text": "How much are we over budget on the campaign?"
    },
    "choices": [
    ...
    "answer": 2,
    "translation": "そのキャンペーンで予算をいくら超過していますか?\n(A) そのキャンペーンは6週間続きました。\n(B) はい、かなり高くつきました。\n(C) 最終的な数字は金曜日まで出そろわないんです。",
    "explanation": "変化球:金額を答えず『まだ集計中で今は言えない』と返すパターン。『今は答えられない』型の正解。(B)はcampaignの繰り返しひっかけ、他の選択肢はWH疑問文にYesで不可。"
  },
  {
    "id": "s6p2-23",
    "question": {
      "speaker": "W",
      "text": "Would you mind training the new hire on the database this afternoon?"
    },
    "choices": [
  ...
  },
  {
    ...
    "question": {
      "speaker": "M",
      "text": "Is there a stationery shop in this building?"
    },
    "choices": [
    ...
    "answer": 1,
    "translation": "この建物の中に文房具店はありますか?\n(A) はい、昨日そこで封筒を買いました。\n(B) ロビーの館内案内板に載っているはずですよ。\n(C) いいえ、オフィスを移すつもりはありません。",
  ...
  },
  {
    ...
    "question": {
      "speaker": "W",
      "text": "The new scheduling app has been running smoothly, hasn't it?"
    },
    "choices": [
    ...
    "answer": 2,
    "translation": "新しい予定管理アプリは順調に動いていますよね?\n(A) スケジュールは掲示板に貼ってあります。\n(B) はい、毎朝数キロ走っています。\n(C) ただ、忙しい週にはまだ試していないんですよ。",
