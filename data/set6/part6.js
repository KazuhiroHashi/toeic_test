...
window.TOEIC_DATA_6.part6 = [
  {
    ...
    questions: [
      ...
      {
        num: 4,
        choices: ["conveniently", "convenience", "convenienced", "convenient"],
        answer: 3,
  ...
  },
  {
    ...
    questions: [
      {
        num: 1,
        choices: ["opened", "closed", "raised", "offered"],
        answer: 1,
      ...
      {
        num: 2,
        choices: ["additionally", "addition", "additional", "adds"],
        answer: 2,
      ...
      {
        num: 4,
        choices: ["maximize", "publicize", "organize", "minimize"],
        answer: 3,
  ...
  },
  {
    ...
    questions: [
      ...
      {
        num: 4,
        choices: ["positive", "temporary", "reluctant", "previous"],
        answer: 0,
  ...
  },
  {
    ...
    questions: [
      {
        num: 1,
        choices: ["pairs", "has paired", "pairing", "will be paired"],
        answer: 3,
      ...
      {
        num: 2,
        choices: ["voluntarily", "voluntary", "volunteer", "volunteered"],
        answer: 1,
      ...
      {
        num: 4,
        choices: ["Once", "During", "Despite", "Whether"],
        answer: 0,
