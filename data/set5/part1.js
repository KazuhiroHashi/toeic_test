...
window.TOEIC_DATA_5.part1 = [
  ...
  },
  {
    ...
    "answer": 2,
    "translation": "(A) 男性がマイクスタンドを立てています。\n(B) 男性が椅子を折りたたんでいます。\n(C) 男性がギターを弾いています。\n(D) 男性がピアノを調律しています。",
  ...
  },
  {
    ...
    "answer": 1,
    "translation": "(A) 男性が車のボンネットを閉めています。\n(B) 男性が車のエンジンを点検しています。\n(C) 男性がタイヤを交換しています。\n(D) 男性が車を運転しています。",
  ...
  },
  {
    ...
    "answer": 3,
    "translation": "(A) 書類が配られているところです。\n(B) 人々が会議のために集まっています。\n(C) プロジェクターが調整されているところです。\n(D) 椅子がテーブルの周りに並べられています。",
