...
window.TOEIC_DATA_5.part3 = [
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "Hi, this is Priya in the accounting department. I'm working from home today, but I can't connect to the company VPN. It keeps saying my password is invalid."
      },
      {
        "speaker": "M",
        "text": "Thanks for calling, Priya. That usually happens when the security app hasn't been updated in a while. When did you last install an update?"
      },
      {
        "speaker": "W",
        "text": "Hmm, I'm not sure. Probably a couple of months ago."
      },
      {
        "speaker": "M",
        "text": "That's likely the cause. I'll send you a link to the latest version. Once you install it, restart your laptop and try logging in again."
      },
      {
        "speaker": "W",
        "text": "Okay. And if it still doesn't work?"
      },
      {
        "speaker": "M",
        "text": "Just call back and reference ticket number three-two-one, and we'll set up a remote session."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "Welcome to Marlowe Books. Can I help you find something?"
      },
      {
        "speaker": "M",
        "text": "Yes, I'm looking for a cookbook called Coastal Kitchen. I checked your shelves but couldn't find it."
      },
      {
        "speaker": "W",
        "text": "Let me check our system... I'm afraid it's sold out at this location. But I can order a copy from our warehouse for you."
      },
      {
        "speaker": "M",
        "text": "How long would that take?"
      },
      {
        "speaker": "W",
        "text": "About four business days. We'll phone you when it arrives, and you can pay when you pick it up."
      },
      {
        "speaker": "M",
        "text": "That works. Let me give you my number."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "David, management wants us to run a customer satisfaction survey before the end of the quarter."
      },
      {
        "speaker": "M",
        "text": "Okay. Are we sending it by e-mail, or posting it on the website?"
      },
      {
        "speaker": "W",
        "text": "Both, I think. But first we need to decide what to ask. Could you draft about ten questions by Wednesday?"
      },
      {
        "speaker": "M",
        "text": "Sure. Should I focus on the delivery service? We've had a few complaints about late shipments lately."
      },
      {
        "speaker": "W",
        "text": "Good idea. I'll book a meeting room so we can review your draft together on Thursday."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "M",
        "text": "Hello, I'd like to book a shuttle to the airport for tomorrow morning. My flight leaves at nine."
      },
      {
        "speaker": "W",
        "text": "Certainly. For a nine o'clock flight, I'd recommend a pickup at six. Traffic can be heavy on the highway."
      },
      {
        "speaker": "M",
        "text": "Six sounds early, but better safe than sorry. I'm at the Fairmont Apartments on Cedar Street."
      },
      {
        "speaker": "W",
        "text": "Got it. The fare is a flat twenty-five dollars, payable to the driver. Cash or card?"
      },
      {
        "speaker": "M",
        "text": "Card, please."
      ...
      {
        "speaker": "W",
        "text": "Perfect. Your driver will text you when he's five minutes away."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "Sam, Nina — we need to finalize the plans for the company's tenth anniversary party next month. I've already booked the rooftop hall downtown."
      },
      {
        "speaker": "M",
        "text": "Nice choice, Grace. How many people are we expecting?"
      },
      {
        "speaker": "W",
        "text": "Around eighty, including partners. Nina, weren't you going to look into a photographer?"
      },
      {
        "speaker": "W2",
        "text": "Yes. I contacted two studios. Brightside is cheaper, but Lumen has much better reviews and can stay the whole evening."
      },
      {
        "speaker": "M",
        "text": "I'd go with Lumen, then — the photos will be around for years. What about catering?"
      },
      {
        "speaker": "W",
        "text": "I'll handle the catering myself. Nina, could you confirm Lumen by Friday? And Sam, please send out the invitations."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "Hi, I'm a member at your gym, and I'll be traveling abroad for two months. Can I pause my membership instead of canceling it?"
      },
      {
        "speaker": "M",
        "text": "Absolutely. We offer a membership freeze for up to three months. There's a small fee of five dollars a month to hold your spot."
      },
      {
        "speaker": "W",
        "text": "That's reasonable. When can it start?"
      },
      {
        "speaker": "M",
        "text": "It can begin on the first of next month. Just come by the front desk with your membership card, and we'll process it."
      },
      {
        "speaker": "W",
        "text": "Great. And can I upgrade to the plan that includes the pool when I get back?"
      },
      {
        "speaker": "M",
        "text": "Of course — just let us know then, and we'll adjust your plan."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "M",
        "text": "Diane, Marcus — the trade show opens at nine tomorrow, so we should finish setting up the booth tonight."
      },
      {
        "speaker": "W",
        "text": "The banners just arrived, but the product samples are still back at the hotel. Someone needs to bring them over."
      },
      {
        "speaker": "M2",
        "text": "I can grab them, Diane. I'm driving to the hotel anyway to pick up the brochures."
      },
      {
        "speaker": "W",
        "text": "Perfect, Marcus. Leo, can you set up the display screen and test the demo video?"
      },
      {
        "speaker": "M",
        "text": "Sure. I'll make sure it's running before we leave tonight."
      },
      {
        "speaker": "W",
        "text": "Great. I'll arrange the tables and chairs. Let's aim to be done by eight."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "Riverbend Brewery, how can I help you?"
      },
      {
        "speaker": "M",
        "text": "Hi, I'd like to book a tour for this Saturday. I'm especially interested in one that includes a tasting."
      },
      {
        "speaker": "W",
        "text": "We have a couple of options. Are you free in the morning or the afternoon?"
      },
      {
        "speaker": "M",
        "text": "The afternoon works better. I have a lunch meeting until twelve thirty."
      },
      {
        "speaker": "W",
        "text": "In that case, the early afternoon tour would be perfect. It includes a guided tasting of four of our beers."
      },
      {
        "speaker": "M",
        "text": "Sounds great. Could you book two spots for me?"
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "Kevin, I'm really sorry, but my last train home is at nine. Is there any way you could close the store tonight?"
      },
      {
        "speaker": "M",
        "text": "I've got tickets to the concert tonight."
      },
      {
        "speaker": "W",
        "text": "Oh, that's right — I completely forgot. Never mind, I'll ask Sophia instead."
      },
      {
        "speaker": "M",
        "text": "Actually, the concert doesn't start until eight thirty. I can stay until eight and help you cash out before I go."
      },
      {
        "speaker": "W",
        "text": "That would be a huge help. Thank you, Kevin."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "M",
        "text": "Hi, the screen on my phone cracked when I dropped it. Can you repair it here?"
      },
      {
        "speaker": "W",
        "text": "We can. Do you know if your phone is still under warranty? If so, the repair might be free."
      },
      {
        "speaker": "M",
        "text": "I bought it about fourteen months ago."
      },
      {
        "speaker": "W",
        "text": "Ah, our standard warranty is twelve months, so unfortunately the repair won't be covered. A screen replacement is eighty dollars."
      },
      {
        "speaker": "M",
        "text": "I see. How long will it take?"
      },
      {
        "speaker": "W",
        "text": "About two hours. If you leave it with us now, it'll be ready by four this afternoon."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "Hi, I have a reservation for a compact car under the name Foster."
      },
      {
        "speaker": "M",
        "text": "Let me find that... Yes, a compact for three days. I have some good news — we've run out of compacts, so we'll upgrade you to a midsize at no extra charge."
      },
      {
        "speaker": "W",
        "text": "Oh, that's fine with me. Does it come with a navigation system?"
      },
      {
        "speaker": "M",
        "text": "It does, and unlimited mileage is included. I'll just need your driver's license and a credit card."
      },
      {
        "speaker": "W",
        "text": "Here you go. One more thing — can I return the car at your downtown branch instead of here at the airport?"
      },
      {
        "speaker": "M",
        "text": "Yes, but there's a fifteen-dollar drop-off fee for returning it at a different location."
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "QuickPrint, how can I help you today?"
      },
      {
        "speaker": "M",
        "text": "Hi, I need to order flyers for a community fair. We're expecting about four hundred people."
      },
      {
        "speaker": "W",
        "text": "We have a few package sizes. I'd suggest ordering a few extra in case more people show up."
      },
      {
        "speaker": "M",
        "text": "Good idea. Let's go with the package that gives us five hundred, then."
      },
      {
        "speaker": "W",
        "text": "Great choice. Will you need them by this Friday?"
      },
      {
        "speaker": "M",
        "text": "The fair is in two weeks, so there's no rush. But can you use recycled paper?"
      }
    ],
  ...
  },
  {
    ...
    "audio": [
      {
        "speaker": "W",
        "text": "Hi, Ron. I took a client to lunch yesterday and paid for it myself. How do I get reimbursed?"
      },
      {
        "speaker": "M",
        "text": "You'll use the expense app on the company portal. Just take a photo of the receipt and upload it under 'Client Meals.'"
      },
      {
        "speaker": "W",
        "text": "Do I need my manager's approval?"
      },
      {
        "speaker": "M",
        "text": "Yes. Once you submit it, your manager gets a notification to approve it. After that, finance processes the payment in the next pay cycle."
      },
      {
        "speaker": "W",
        "text": "Got it. And what if I lose a receipt?"
      },
      {
        "speaker": "M",
        "text": "Then you'd have to fill out a missing-receipt form, but it's much easier to just hold on to the receipt."
      }
    ],
