// セット3 Part 3: 会話問題(13会話39問。3人の会話×2、図表問題×2、意図問題を含む)
...
window.TOEIC_DATA_3.part3 = [
  {
    ...
    title: "会話 1",
    audio: [
      { speaker: "W", text: "Hi, I'm here to pick up a prescription for Diane Foster." },
      { speaker: "M", text: "Let me check... I'm sorry, but it isn't quite ready yet. The pharmacist is still filling it, so it will be about fifteen more minutes." },
      { speaker: "W", text: "Oh, I have another errand nearby. Can I come back around four?" },
      { speaker: "M", text: "That's fine. And just so you know, this medication should be taken with food, so I'll include an instruction sheet." }
    ],
  ...
  },
  {
    ...
    title: "会話 2",
    audio: [
      { speaker: "W", text: "Hello, I have a reservation for a compact car under the name Alvarez, picking up this morning." },
      { speaker: "M", text: "Thank you, Ms. Alvarez. I see your booking. Unfortunately, we've run out of compact cars, so I'd like to offer you a midsize SUV at no extra charge." },
      { speaker: "W", text: "That works for me. Does it have a navigation system? I'm not familiar with the area." },
      { speaker: "M", text: "It does, and I'll set your hotel as the destination before you leave. Just be sure to return the vehicle with a full tank." }
    ],
  ...
  },
  {
    ...
    title: "会話 3",
    audio: [
      { speaker: "W", text: "Excuse me, I'm looking for a book called Coastal Birds of the Pacific, but it isn't on the shelf." },
      { speaker: "M", text: "Let me look it up... It's currently checked out and due back next Wednesday. Would you like me to place a hold on it for you?" },
      { speaker: "W", text: "Yes, please. Can you notify me by e-mail when it becomes available?" },
      { speaker: "M", text: "Of course. And if you need it sooner, we can request a copy from our branch across town through interlibrary loan." }
    ],
  ...
  },
  {
    ...
    title: "会話 4",
    audio: [
      { speaker: "M", text: "IT support, this is Kevin. How can I help?" },
      { speaker: "W", text: "Hi, I can't log in to the expense reporting system. It keeps saying my password has expired, even though I just reset it yesterday." },
      { speaker: "M", text: "I see. Sometimes the system takes a few hours to sync a new password. Let me reset it manually on my end right now." },
      { speaker: "W", text: "Thank you. I have a reimbursement claim due today, so I really need it working." },
      { speaker: "M", text: "Understood. Try logging in again in five minutes, and call me back if it still fails." }
    ],
  ...
  },
  {
    ...
    audio: [
      { speaker: "W", text: "Ben, Grace — let's finalize the plan for the company charity run. Registration opens Monday. Ben, are you still managing the online sign-up form?" },
      { speaker: "M", text: "Yes, Priya. The form is ready. I just need someone to write the description of the route and the start time." },
      { speaker: "W2", text: "I can do that, Ben. I ran the same course last year, so I know it well." },
      { speaker: "W", text: "Great, Grace. Then I'll take care of ordering the T-shirts for the participants. What size range should I order?" },
      { speaker: "M", text: "Let's go with small through extra-large. And could you order about ten extra, just in case?" },
      { speaker: "W", text: "Good idea. I'll place that order this afternoon." }
    ],
  ...
  },
  {
    ...
    title: "会話 6",
    audio: [
      { speaker: "M", text: "Good afternoon, Bella Cucina. This is Antonio." },
      { speaker: "W", text: "Hi, I have a dinner reservation for four people this Saturday at seven, but two more colleagues can now join us. Could you change it to six?" },
      { speaker: "M", text: "Let me check our availability... Seven o'clock is fully booked for a party of six, but I could seat you at seven forty-five." },
      { speaker: "W", text: "That's fine. Could we also have a table near the window, if possible?" },
      { speaker: "M", text: "I'll note your request, though I can't guarantee it. We'll see you Saturday at seven forty-five." }
    ],
  ...
  },
  {
    ...
    audio: [
      { speaker: "W", text: "There you are. Our meeting in Millford starts at nine thirty. Which train should we take?" },
      { speaker: "M", text: "The eight-ten express would get us there fastest, but I still need to grab a coffee and print the handouts." },
      { speaker: "W", text: "Then let's take the next one to Millford. It's a local, so it stops a few times, but we'll still arrive with time to spare." },
      { speaker: "M", text: "Sounds good. I'll meet you on the platform in ten minutes." }
    ],
  ...
  },
  {
    ...
    title: "会話 8(意図問題)",
    audio: [
      { speaker: "W", text: "Sam, I'm scheduled to run the front desk this Saturday, but my daughter's recital got moved to that day. Is there any way you could cover for me?" },
      { speaker: "M", text: "Saturday... I was planning to catch up on the quarterly report." },
      { speaker: "W", text: "I completely understand if you can't. I can ask Elena instead." },
      { speaker: "M", text: "No, no. The report can wait until Sunday. I'll cover the desk for you." },
      { speaker: "W", text: "You're a lifesaver. I'll take your next weekend shift in return." }
    ],
  ...
  },
  {
    ...
    title: "会話 9",
    audio: [
      { speaker: "M", text: "Hi, I'm interested in joining. What membership options do you offer?" },
      { speaker: "W", text: "Welcome! We have a monthly plan and an annual plan. The annual one works out cheaper if you come regularly, and it includes two free personal training sessions." },
      { speaker: "M", text: "That sounds good. Can I try the facilities before I decide?" },
      { speaker: "W", text: "Absolutely. I can give you a one-day guest pass right now, along with a quick tour of the weight room and the pool." },
      { speaker: "M", text: "Perfect. Let's start with the tour, then." }
    ],
  ...
  },
  {
    ...
    audio: [
      { speaker: "M", text: "Nora, Victor — the trade show opens tomorrow at ten. Let's make sure the booth is ready. Nora, how's the banner coming?" },
      { speaker: "W", text: "The main banner is hung, Leo, but the printed brochures haven't arrived yet. The delivery company says they'll be here by eight tomorrow morning." },
      { speaker: "M2", text: "That's cutting it close. I'll bring the digital versions on tablets as a backup, in case they're delayed." },
      { speaker: "M", text: "Smart thinking, Victor. And could you also test the demo laptop tonight? We can't have it freezing during a presentation." },
      { speaker: "M2", text: "Will do. I'll set it up and run through the slides after dinner." },
      { speaker: "W", text: "And I'll get to the venue early to arrange the giveaways on the table." }
    ],
  ...
  },
  {
    ...
    title: "会話 11",
    audio: [
      { speaker: "W", text: "Hi, I'd like to have this suit jacket taken in. It's a little loose around the waist." },
      { speaker: "M", text: "Sure, let me take a look. Yes, I can bring in the sides for you. When do you need it by?" },
      { speaker: "W", text: "I have a wedding to attend a week from Saturday. Is that enough time?" },
      { speaker: "M", text: "Plenty. It'll be ready this Thursday. The alteration will be forty dollars, payable when you pick it up." },
      { speaker: "W", text: "Great. I'll come by Thursday afternoon, then." }
    ],
  ...
  },
  {
    ...
    audio: [
      { speaker: "M", text: "The afternoon has four sessions, but we can only cover so much between the two of us. Which one should each of us attend?" },
      { speaker: "W", text: "You should definitely take the one on measuring results with numbers — that's your specialty, and we need those insights for the report." },
      { speaker: "M", text: "Good point. I'll take that one. What about you?" },
      { speaker: "W", text: "I'll go to the two o'clock session on social media. Let's compare notes over coffee afterward." }
    ],
  ...
  },
  {
    ...
    title: "会話 13",
    audio: [
      { speaker: "W", text: "Hello, Brightframe Studio. This is Mia." },
      { speaker: "M", text: "Hi, I'd like to book a session for professional headshots for our new employees. There are about twelve of them." },
      { speaker: "W", text: "We can do that. For groups, we usually come to your office with portable equipment. Would that be more convenient?" },
      { speaker: "M", text: "Yes, that would save everyone time. How long would twelve people take?" },
      { speaker: "W", text: "Roughly two hours. I'd suggest a weekday morning. I can send you a quote and some sample photos by e-mail today." }
    ],
