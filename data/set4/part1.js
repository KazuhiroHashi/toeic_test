...
window.TOEIC_DATA_4.part1 = [
  {
    ...
    answer: 0,
    translation: "(A) 料理人がまな板で野菜を刻んでいます。\n(B) 料理人が流しで皿を洗っています。\n(C) 料理人がコンロで鍋をかき混ぜています。\n(D) 料理人がエプロンを外しているところです。",
  ...
  },
  {
    ...
    answer: 2,
    translation: "(A) 人々が小道で自転車に乗っています。\n(B) 男性が自転車に鍵をかけています。\n(C) 何台かの自転車が柵に沿って並べられています。\n(D) 自転車がラックに積み込まれているところです。",
  ...
  },
  {
    ...
    answer: 3,
    translation: "(A) 男性が車に給油しています。\n(B) 車が車庫の中に停められています。\n(C) 男性がパンクしたタイヤを交換しています。\n(D) 車が洗われているところです。",
