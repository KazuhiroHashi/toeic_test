// セット4 Part 3: 会話問題(13会話39問。3人の会話×2、図表問題×2、意図問題を含む)
...
window.TOEIC_DATA_4.part3 = [
  {
    ...
    title: "会話 1",
    audio: [
      { speaker: "W", text: "Hi, I'm looking for a cookbook called Coastal Kitchen, but I don't see it anywhere on your shelves." },
      { speaker: "M", text: "Let me check our system... I'm afraid we're out of it right now, but I can place a special order for you. It usually arrives within five days." },
      { speaker: "W", text: "That would be great. Do I need to pay for it today?" },
      { speaker: "M", text: "Just a small deposit now, and the rest when you come to collect it. I'll give you a call the moment it comes in." }
    ],
  ...
  },
  {
    ...
    title: "会話 2",
    audio: [
      { speaker: "M", text: "Hello, I rented a compact car from your downtown branch, and I'd like to keep it for two extra days. Is that possible?" },
      { speaker: "W", text: "Let me pull up your reservation... Yes, we can extend it through Thursday. The daily rate stays the same, so it will be an additional ninety dollars." },
      { speaker: "M", text: "That's fine. Do I need to bring the car in to sign anything?" },
      { speaker: "W", text: "No, I can update everything over the phone. I'll email you a revised agreement to confirm the new return date." }
    ],
  ...
  },
  {
    ...
    title: "会話 3",
    audio: [
      { speaker: "M", text: "Excuse me, are you from the IT team? I joined the accounting department this morning, and I can't get into my new laptop." },
      { speaker: "W", text: "Yes, I can help with that. Did you receive a temporary password by email earlier today?" },
      { speaker: "M", text: "I did, but when I type it in, it says the password has already expired." },
      { speaker: "W", text: "That happens if it isn't used within a couple of hours. I'll reset it now and walk you through creating a permanent one." }
    ],
  ...
  },
  {
    ...
    title: "会話 4",
    audio: [
      { speaker: "M", text: "Hi, I'm here to pick up a suit I dropped off for alterations. The name is Carter." },
      { speaker: "W", text: "Let me find it... Here we are. We took in the waist and shortened the sleeves, just as you requested." },
      { speaker: "M", text: "Great. It was a little loose before, so I hope it fits now." },
      { speaker: "W", text: "Why don't you try it on to make sure? The fitting room is right around the corner on your left." }
    ],
  ...
  },
  {
    ...
    audio: [
      { speaker: "W", text: "Thanks for coming, Leo and Sam. We're producing a promotional video for the company website, and we shoot next Wednesday. Let's finalize the plan." },
      { speaker: "M", text: "I'll take care of the camera and lighting. I just need to know how many locations we're filming at." },
      { speaker: "W", text: "Three — the lobby, the workshop, and the rooftop. Sam, can you set up the staff interviews?" },
      { speaker: "M2", text: "Sure, Rachel. I'll line up four employees and prepare the questions ahead of time." },
      { speaker: "M", text: "One concern — the rooftop shot depends on the weather. Should we plan a backup?" },
      { speaker: "W", text: "Good point. If it rains, we'll film in the conference room instead. I'll check the forecast on Tuesday." }
    ],
  ...
  },
  {
    ...
    title: "会話 6",
    audio: [
      { speaker: "W", text: "Good afternoon, Bright Smile Dental. How can I help you?" },
      { speaker: "M", text: "Hi, I have a cleaning appointment tomorrow at ten, but something came up at work. Could I move it to Friday?" },
      { speaker: "W", text: "Let me check the schedule... Dr. Nolan has an opening on Friday at two thirty. Would that suit you?" },
      { speaker: "M", text: "Perfect. And do I still need to arrive early to fill out forms?" },
      { speaker: "W", text: "Only the short update form this time, since you're already a patient. It takes just a couple of minutes." }
    ],
  ...
  },
  {
    ...
    audio: [
      { speaker: "M", text: "Priya, Grace — let's finalize the marketing webinar for next month. I'll be the main presenter, covering social media trends." },
      { speaker: "W", text: "Sounds good. I'll prepare the slides and set up the live poll. Grace, can you manage the registration page?" },
      { speaker: "W2", text: "Of course. I'll have it ready today. How many people are we expecting?" },
      { speaker: "M", text: "About two hundred, based on last time. We really should test the streaming software beforehand." },
      { speaker: "W", text: "I'll run a full rehearsal on Thursday so we can catch any audio problems early." },
      { speaker: "W2", text: "And I'll send everyone the login link as soon as registration opens." }
    ],
  ...
  },
  {
    ...
    audio: [
      { speaker: "M", text: "Two tickets to Maple Cove, please. We'd like the earliest boat that goes there." },
      { speaker: "W", text: "The next departure to Maple Cove leaves at eleven. That gives you about twenty minutes to board." },
      { speaker: "M", text: "Actually, my friend is still parking the car. Could we take the later one instead?" },
      { speaker: "W", text: "No problem. I'll put you on the twelve-fifteen. Boarding starts fifteen minutes before departure at gate two." }
    ],
    ...
    questions: [
      {
        ...
        choices: ["9:00", "10:30", "11:00", "12:15"],
        answer: 3,
  ...
  },
  {
    ...
    title: "会話 9(意図問題)",
    audio: [
      { speaker: "W", text: "Tom, the grant proposal has to be submitted online by five o'clock today. How is the budget section coming along?" },
      { speaker: "M", text: "It's finished. I'm just waiting for the director to approve the final figures before I upload everything." },
      { speaker: "W", text: "The director is in meetings until four thirty." },
      { speaker: "M", text: "I know. I've already messaged her asking her to review it between sessions. If she can't, I'll call her assistant." },
      { speaker: "W", text: "Good thinking. Let me know the moment it's approved so I can double-check the attachments." }
    ],
  ...
  },
  {
    ...
    title: "会話 10",
    audio: [
      { speaker: "W", text: "Hi, I just bought this dining table and six chairs. Could you deliver them to my apartment?" },
      { speaker: "M", text: "Certainly. Delivery within the city is free for orders over five hundred dollars, so yours qualifies. When would you like it?" },
      { speaker: "W", text: "This Saturday, if possible. Also, do the chairs come assembled?" },
      { speaker: "M", text: "The table does, but the chairs need assembly. For a small fee, our crew can put them together for you during delivery." },
      { speaker: "W", text: "Yes, please add that. I'd rather not deal with it myself." }
    ],
  ...
  },
  {
    ...
    title: "会話 11",
    audio: [
      { speaker: "M", text: "Hi, I currently have the basic gym membership, but I'd like to add access to the swimming pool. How does that work?" },
      { speaker: "W", text: "You'd move up to our premium plan. It's fifteen dollars more per month and includes the pool, the sauna, and group classes." },
      { speaker: "M", text: "That sounds worth it. Can I switch starting next month?" },
      { speaker: "W", text: "Absolutely. I'll update your account now, and the new rate applies from the first billing cycle. Your membership card already works for all areas, so nothing else changes." }
    ],
  ...
  },
  {
    ...
    audio: [
      { speaker: "W", text: "Welcome to Deskwave. Are you looking for space just for yourself, or for a team?" },
      { speaker: "M", text: "It's for my startup — there are four of us, and we'd really like our own enclosed room." },
      { speaker: "W", text: "In that case, one of our private offices would suit you. We have rooms for two people or for four." },
      { speaker: "M", text: "We definitely need room for all four. Is there a discount if we sign a longer contract?" },
      { speaker: "W", text: "Yes — ten percent off the monthly rate if you commit to a twelve-month term." }
    ],
  ...
  },
  {
    ...
    title: "会話 13",
    audio: [
      { speaker: "M", text: "Hi, I'm picking up a prescription for Alan Reyes." },
      { speaker: "W", text: "Let me check... Here it is. Have you taken this medication before? It can cause drowsiness, so please avoid driving after your first dose." },
      { speaker: "M", text: "Good to know, thanks. It's actually my first time. How often should I take it?" },
      { speaker: "W", text: "Twice a day, with food. The full instructions are printed on the label. If you notice any side effects, call us or your doctor." },
      { speaker: "M", text: "Understood. Do I pay here or at the front register?" },
      { speaker: "W", text: "You can pay right here." }
    ],
