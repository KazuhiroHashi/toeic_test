...
for(let k=2;k<=6;k++)parts.forEach(p=>{const f="data/set"+k+"/"+p+".js";if(fs.existsSync(f))eval(fs.readFileSync(f,"utf8"));});
const SETS=[["S1",window.TOEIC_DATA],["S2",window.TOEIC_DATA_2],["S3",window.TOEIC_DATA_3],["S4",window.TOEIC_DATA_4],["S5",window.TOEIC_DATA_5],["S6",window.TOEIC_DATA_6]];
